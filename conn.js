...
*_Seputar Sanzz Bot & transaksi_*

${strip}Telpon/Spam blokir 🚫${strip}

_Admin 1 : 0812-3616-7286_

*SCRIPT BOT 🛒*
_Rp50.000 - ( Topup & Fitur 300+ )_
_Rp70.000 - ( Topup & Fitur 600+ )_
...
const gurbot = '6281341554776@s.whatsapp.net'
const mark_slebew = '0@s.whatsapp.net'
var footer_nya =`𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝐍𝐨𝐭𝐡𝐢𝐧𝐠>_`
...
var bg_lexxy = '6281236167286@s.whatsapp.net'
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by Skyzz' })
}
console.log(feta)
}
break
...
if (!q) return reply('link githubnya mana?\n*Contoh:*\n#gitclone https://github.com/4ksanzz/igfhl.dx17')
var linknya = q
...
.then(data => {
var opt = { packname: 'Skyzz', author: '𝐈𝐠 𝐟𝐡𝐥.𝐝𝐱𝟏𝟕' }
...
var dev = '6281236167286@s.whatsapp.net'
